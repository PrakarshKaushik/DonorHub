<!-- Inserting data of student by admin -->
...
<body class="bg-dark">
	...
	<!-- form for adding details of student -->
					...
					<div class="card" style="background-color: #D5CEA3;">
						<div class="card-body p-4">
							<form class="mb-3 mt-md-4" action="user?action=adminRegister"
								method="post">
								<h2 class="fw-bold mb-2">Add Student</h2>
								<p class=" mb-5">Please enter student's details for
									registration!</p>
								<div class="mb-3">
